---
title: "Module 7b | Intermediate Data Science Tools"
...
Em Quarto, existe uma funcionalidade que permite a reutilização eficiente de conteúdo entre vários documentos. 
Esta característica é especialmente útil em projetos que exigem que secções de texto, código ou resultados de análises sejam partilhados entre diferentes outputs, garantindo consistência e reduzindo o tempo despendido em atualizações. 
...
Os Quarto Dashboards são uma nova poderosa ferramenta para criar relatórios interativos e dinâmicos utilizando a tecnologia Quarto. 
Este nova tipologia foi projetada para combinar a simplicidade da criação de documentos dinâmicos com a interatividade de dashboards, o Quarto facilita a publicação de análises de dados visuais e interativos na web ou em documentos offline.
