...
format: 
  dashboard:
    nav-buttons: [github]
    github: https://github.com/aperaltasantos
    scrolling: true 
...
ggplotly(csp |> 
           filter(
             ARS=="Norte",
             Período>=max(csp$Período)-30
           ) |> 
           arrange(Período) |> 
  ggplot(aes(
    x=Período,
    y=`Nº Consultas Gripe nos CSP`
  ))+
  ...
  labs(title = "Nº Consultas Gripe nos CSP da ARS Norte",
...
ggplotly(csp |> 
  ...
  ggplot(aes(
    ...
    y=`Nº Consultas Gripe nos CSP`
     ...
     geom_line(linewidth=1.15) + #nos geom de linha o argumento size também funciona para a grossura mas está a mudar para linewidth
  labs(title = "Nº Consultas Gripe nos CSP da ARS Lisboa e Vale do Tejo",
         subtitle = paste0(year(min(csp$Período)),"-",year(max(csp$Período))),
         y = "Nº Consultas Gripe nos CSP",
         x = "Data", 
         caption = "Fonte: Portal de Transparência, Portugal",
...
ggplotly(csp |> 
  ...
  ggplot(aes(
    ...
    y=`Nº Consultas Gripe nos CSP`
     ...
     geom_line(linewidth=1.15) + #nos geom de linha o argumento size também funciona para a grossura mas está a mudar para linewidth
  labs(title = "Nº Consultas Gripe nos CSP da ARS Centro",
         subtitle = paste0(year(min(csp$Período)),"-",year(max(csp$Período))),
         y = "Nº Consultas Gripe nos CSP",
         x = "Data", 
         caption = "Fonte: Portal de Transparência, Portugal",
...
ggplotly(csp |> 
  ...
  ggplot(aes(
    ...
    y=`Nº Consultas Gripe nos CSP`
     ...
     geom_line(linewidth=1.15) + #nos geom de linha o argumento size também funciona para a grossura mas está a mudar para linewidth
  labs(title = "Nº Consultas Gripe nos CSP da ARS Alentejo",
         subtitle = paste0(year(min(csp$Período)),"-",year(max(csp$Período))),
         y = "Nº Consultas Gripe nos CSP",
         x = "Data", 
         caption = "Fonte: Portal de Transparência, Portugal",
...
ggplotly(csp |> 
  ...
  ggplot(aes(
    ...
    y=`Nº Consultas Gripe nos CSP`
     ...
     geom_line(linewidth=1.15) + #nos geom de linha o argumento size também funciona para a grossura mas está a mudar para linewidth
  labs(title = "Nº Consultas Gripe nos CSP da ARS Algarve",
         subtitle = paste0(year(min(csp$Período)),"-",year(max(csp$Período))),
         y = "Nº Consultas Gripe nos CSP",
         x = "Data", 
         caption = "Fonte: Portal de Transparência, Portugal",
