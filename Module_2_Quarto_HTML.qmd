...
Os estudantes de Data Science for healthcare são os melhores. [^module_2_quarto_html-1][^module_2_quarto_html-2]

[^module_2_quarto_html-1]: Isto é uma nota de rodapé.

[^module_2_quarto_html-2]: Readers Digest
...
É possível adicionar hiperlinks com ![texto](caminho) ![figure 1](images/lisboa.jpeg){#fig-lisboa} , como por exemplo na @fig-lisboa.
...
Exemplo de bibliografia na Data Science @wickham2023r, @knuth84, @guo2023big .
