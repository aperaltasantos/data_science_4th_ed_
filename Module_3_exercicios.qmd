...
get_results(report)
save_report(report, output_file ="outputs/validation_report_module3.html")
...
```{=html}
<iframe width="100%" height=1000 src="outputs/validation_report_module3.html"></iframe>
```
