...
theme_set(theme_minimal(base_size = 12, family = "Open Sans"))
```
...
::: callout-warning
**ATENÇÃO** Se queremos definir uma cor temos de Dedinir fora o aes.
:::
...
```{r}
p1<- ggplot(data= inpatient_hospital_year_mean, 
            aes(x = year, 
                y = mean_saidos_var) 
            ) +
