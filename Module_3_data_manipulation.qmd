...
![Importar dados](images/import.png){#fig-import} 

Pode importar um dataset no RStudio @fig-import através de cliques no painel "Files" é um processo intuitivo, especialmente para quem prefere uma abordagem mais visual em vez de escrever código manualmente. Os passos são os seguintes:
...
conjunto de dados. Vamos verificar se precisamos de todas elas @fig-select.

![Esquema de uso do Select](images/select.png){#fig-select}   
...
Este argumento permite filtrar valores ou strings dentro das variáveis, ver @fig-filtro.

![Esquema de uso do filtro](images/filter.png){#fig-filtro}
...
![Esquema de utilização do Mutate](images/mutate.png){#fig-mutate}
...
![Esquema de utilização do summarise](images/summarize.png){#fig-summarize}
...
![Formato de datas no R](images/date_formats.jpeg){#fig-datas}
